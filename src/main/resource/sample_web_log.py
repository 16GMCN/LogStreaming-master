...
class WebLogGeneration(object):
    ...
    # the fundamental construct function
    def __init__(self):
        ...
        self.http_refer = [ "http://www.baidu.com/s?q={query}","http://www.google.cn/search?q={query}","http://www.sogou.com/web?q={query}","http://one.cn.yahoo.com/s?q={query}","http://cn.bing.com/search?q={query}"]
